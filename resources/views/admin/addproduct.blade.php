    ...
    <div class="container-fluid py-4 px-4">
        <div class="container">
            ...
            <form method="POST" action="{{ route('admin.storeProduct') }}" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4">
                    <input name="price" type="number" id="form4Example2" placeholder="Price" class="form-control" />   
                </div>
                <div class="mb-3">
                ...
                <!-- Message input -->
                <div class="form-outline mb-4">
                    <textarea name="description" class="form-control" id="form4Example3" placeholder="Description"  rows="4"></textarea>
                </div>
                <div class="form-outline mb-4">
                    <input name="feature" type="number" id="form4Example1" placeholder="Feature" class="form-control" />
                </div>
                <!-- Submit button -->
